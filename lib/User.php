...
class User{
	...
	public function userRegistration($data){
		...
		if (strlen($username) < 3) {
			...
			Username must only contain alphanumerical,dashes and underscores !</div>";
		}
	...
	public function userLogin($data){
		...
		if ($result) {
			...
			Session::set("loginmsg","<div class='alert alert-success'><strong>Success ! !</strong>You are loggeIn !</div>");
			header("Location:index.php");

		} else {
        $msg = "<div class='alert alert-danger'><strong>Error !</strong>Do not found !</div>";
			return $msg;
		}
